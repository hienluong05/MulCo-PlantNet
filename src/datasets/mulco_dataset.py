...
class MulCoDataset(Dataset):
    ...
    def _load_image_caption_mapping(self) -> Dict[str, str]:
        ...
        print(f"[MulCoDataset] Loaded image-caption mapping: {len(mapping)} entries")
        return mapping
    ...
    def _build_samples(self) -> List[dict]:
        ...
        print(f"[MulCoDataset] Total selected images: {len(image_paths)}")
        print(f"[MulCoDataset] Valid samples: {len(samples)}")
        print(f"[MulCoDataset] Skipped missing caption: {skipped_missing_caption}")
        print(f"[MulCoDataset] Skipped invalid caption: {skipped_invalid_caption}")
        print(f"[MulCoDataset] Matched by external mapping: {mapped_by_file}")
        print(f"[MulCoDataset] Num classes: {len(self.class_to_idx)}")
        print(f"[MulCoDataset] class_to_idx: {self.class_to_idx}")
